...
import PartyStatement from "./pages/seller/PartyStatement.jsx";
import SalesOverview from "./pages/seller/SalesOverview.jsx";
import BestSellers from "./pages/seller/BestSellers.jsx";
      ...
      <div className={isSellerPath ? "" : "x-6 md:px-16 lg:px-24 xl:px-16"}>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="reports/purchase" element={<BestSellers />} />
          </Route>
