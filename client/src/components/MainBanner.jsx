      ...
      <div className="relative z-10 px-4 sm:px-6 text-center sm:text-left">
        <div className="bg-white opacity-90 backdrop-blur-md p-5 sm:p-8 rounded-2xl shadow-lg max-w-md sm:max-w-2xl mx-auto">
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-gray-900 leading-tight">
            Premium Quality <br />
            <span className="bg-[#1C6B2E] bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:justify-start">
            <button className="group flex items-center justify-center gap-2 px-5 py-3 text-sm sm:text-base text-white bg-[#AD3A24] rounded-lg shadow-lg hover:bg-green-700 transition-all duration-300 hover:shadow-green-400/40 hover:scale-105 active:scale-95">
              Shop Now
              <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 transform transition-transform duration-300 group-hover:translate-x-1" />
            </button>

            <button className="group px-5 py-3 text-sm sm:text-base border-2 border-green-600 rounded-lg text-white bg-[#c87565] hover:bg-green-50 transition-all duration-300 hover:shadow-lg hover:border-green-700 hover:scale-105 active:scale-95">
              View All Products
            </button>
          </div>
        </div>
