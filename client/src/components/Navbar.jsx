...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-4 md:px-10 lg:px-16 py-2.5 bg-[#ffffff] backdrop-blur-sm border-b border-gray-100 shadow-sm sticky top-0 z-50 transition-all">
      {/* Logo */}
