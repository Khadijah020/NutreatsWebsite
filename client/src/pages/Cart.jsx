...
const Cart = () => {
  ...
  return products.length > 0 && cartItems ? (
    <>
      <SEO
        title="Shopping Cart | NuTreats"
        description="Review your cart items and proceed to checkout. Free delivery in Lahore on orders over Rs. 1500."
        url="http://localhost:5173/cart"
        canonicalUrl="http://localhost:5173/cart"
        noindex={true}
        nofollow={true}
      />
                ...
                >
                  ...
                  <div className="flex items-start sm:items-center gap-4 w-full sm:w-auto">
                    ...
                    >
                      <img
                        src={product.image[0]}
                        alt={`${product.name} in shopping cart`}
